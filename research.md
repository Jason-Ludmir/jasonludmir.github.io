...
4. [**Layerwise Federated Learning for Heterogeneous Quantum Clients using Quorus**](https://arxiv.org/abs/2510.06228)  
   Jason Han, Nicholas S. DiBrita, Daniel Leeds, Jianqiang Li, *Jason Ludmir*, and Tirthak Patel.
   ICLR, 2026

5. [**Anchor: Reducing Temporal and Spatial Output Performance Variability on Quantum Computers**](https://arxiv.org/abs/2510.06172)  
   Yuqian Huo, Daniel Leeds, *Jason Ludmir*, Nicholas S. DiBrita, Tirthak Patel
   ACM SIGMETRICS, 2026

6. [**ReCon: Reconfiguring Analog Rydberg Atom Quantum Computers for Quantum Generative Adversarial Networks**](https://arxiv.org/abs/2408.13389)  
